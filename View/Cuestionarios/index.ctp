<div class="cuestionarios index">
	...
	<tr>
		...
		<td><?php echo h($cuestionario['Cuestionario']['titulo']); ?>&nbsp;</td>
		<td><?php echo h($cuestionario['Cuestionario']['descripcion']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $cuestionario['Cuestionario']['id']), null, __('Are you sure you want to delete # %s?', $cuestionario['Cuestionario']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
