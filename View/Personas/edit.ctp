...
<section class="index_body">
				...
				<table>
					<tr>	
						...
						<td>
							...
							<?php echo $this->Form->input("tiposidentificacion_id", array("label" => false,"required" => "required"));?>
						</td>
					</tr>
					<tr>	
						<th>
					...
					<tr>	
						...
						<td>
							<?php echo $this->Form->input("fecha de nacimiento", array("label" => false,"required" => "required"));?>
						</td>
					</tr>
					<div>
	...
	<table class="acciones">
		<tr>
			<td>
				<?php echo $this->Form->end(array('label' => 'Guardar','div' => array('class' => 'div_submit_centrado_2')));?>

			</td>
			<td>
				<?php echo $this->Form->postLink(__('Borrar'), array('action' => 'delete', $this->request->data['Persona']['id']),array('class' => 'acciones_eliminar'), __('Esta seguro que desea eliminar a %s?', $this->request->data['Persona']['nombre']." ".$this->request->data['Persona']['apellido'])); ?>
			</td>
		</tr>
	</table>	
	</br>
