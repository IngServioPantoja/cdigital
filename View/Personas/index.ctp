...
-->
						<td class="actions">
							...
							<?php echo $this->Form->postLink(__('Borrar'), array('action' => 'delete', $persona['Persona']['id']), null, __('¿Realmente desea eliminar a %s?', $persona['Persona']['nombre']." ".$persona['Persona']['apellido'])); ?>
						</td>
					</tr>
				<?php endforeach;?>
					</tbody>
